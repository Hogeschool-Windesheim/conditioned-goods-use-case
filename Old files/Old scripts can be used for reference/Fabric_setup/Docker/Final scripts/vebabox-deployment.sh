...
# General
  ...
  hostname=VebaBox-Node

# Docker
	docker_network=CondGoods-Network

# Docker TLS-CA container
	tls_admin=veba-tls-admin
	tls_admin_pass=veba-tls-admin-Welkom01!
...
# Docker Organizational-CA container
	ca_admin=veba-rca-admin
	ca_admin_pass=veba-rca-admin-Welkom01!
...
# Docker Intermediate-CA container
	intca_admin=veba-int-admin
	intca_admin_pass=veba-int-admin-Welkom01!
...
# Docker Peer containers
  ...
  docker_peer0_pass=peer0-vebabox-Welkom01!
  ...
  docker_peer1_pass=peer1-vebabox-Welkom01!
